...
## Описание
Lagerhaus - это приложение для управления складом, которое позволяет управлять продуктами, категориями, поставщиками, заказами и клиентами.
...
## Использование
После запуска сервера, вы можете получить доступ к приложению по адресу [http://127.0.0.1:8000/](http://127.0.0.1:8000/). Вот основные URL-адреса:
