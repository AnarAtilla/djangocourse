...
class Member(models.Model):
    ...
    age = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(6), MaxValueValidator(120)], verbose_name="Age")
...
class Book(models.Model):
    ...
    genre = models.CharField(max_length=50, choices=[('Fiction', 'Fiction'), ('Non-Fiction', 'Non-Fiction')], null=True, verbose_name="Genre")
