    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='project_tasks.project')),
                ('tags', models.ManyToManyField(blank=True, related_name='tasks', to='project_tasks.tag')),
            ],
        ),
    ]
